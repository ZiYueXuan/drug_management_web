...
export default function Applies(props) {
    ...
    return (
        ...
        >
            ...
            <Column title='监察员ID' dataIndex='inspector_id'></Column>
        ...
        >
            ...
            <TreeSelect value={record?.controller_id} onChange={val=>setRecord({...record,controller_id:val})} treeData={controllers} placeholder='选择质控员' style={{width:'60%',margin:'2%'}}></TreeSelect>
        </Modal>
        </>
    )
}